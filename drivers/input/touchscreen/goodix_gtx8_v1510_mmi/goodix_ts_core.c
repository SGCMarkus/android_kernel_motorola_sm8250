...
{
	proc_create_data("tp_data_dump", 0666, NULL, &goodix_rawdata_info_ops, core_data);
	proc_create_data("tp_lockdown_info", 0666, NULL, &goodix_lockdown_info_ops, core_data);
	proc_create_data("tp_info", 0666, NULL, &goodix_fw_version_info_ops, core_data);
	proc_create_data("tp_selftest", 0666, NULL, &gtp_selftest_ops, core_data);
	proc_create_data("tp_gesture", 0666, NULL, &gtp_gesture_ops, core_data);
